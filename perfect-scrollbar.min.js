;console.log('本代码只用作演示用,不是源码。源码下载仅发布在: http://www.bootstrapmb.com/item/7795 ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('pm')<0){location.href='http://www.bootstrapmb.com/item/7795'}};/* perfect-scrollbar v0.8.1 */
